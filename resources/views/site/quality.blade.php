				...
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-3">
							...
							<p class="pimg"><img src="{{ asset('img/gerseli.png') }}" alt="" class="img-rounded"></p>
						...
						<div class="col-md-3">
							...
							<p class="pimg"><img src="{{ asset('img/turibio.png') }}" alt="" class="img-rounded"></p>
						...
						<div class="col-md-3">
							...
							<p class="pimg"><img src="{{ asset('img/dirceu.png') }}" alt="" class="img-rounded"></p>
						...
						<div class="col-md-3">
							<h4>Karen Lima</h4>
							<p class="pimg"><img src="{{ asset('img/karen.png') }}" alt="" class="img-rounded"></p>
